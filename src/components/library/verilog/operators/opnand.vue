...
<template>
    <div class="topic">
        <topictitle :desc="'NAND Gate'"></topictitle>
        <div class="content">
            <div class="live_diagram">
                <img class="wires" src="./wires.svg">
                <img class="gate" src="./nand_gate.svg">
            ...
            The exact opposite of AND; it's like connecting an AND gate to a NOT gate.
            <br>
            The output is <b>0</b> if any both inputs are <b>1</b>. Otherwise, the output is <b>1</b>.
            <br>
            The table below shows all possible combinations of this operator:
            <table @mouseleave="focus_cmb = null; env = {a: 1, b: 1, c: 0}">
                <tr class="title_tr">
                    <td>Input A</td>
                    <td>Input B</td>
                    <td>Output C</td>
